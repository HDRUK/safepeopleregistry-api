...
<mj-text font-weight="400" />
        ...
        <mj-text font-weight="400" />
          ...
          [[PLACEHOLDER_ISSUER_NAME]]<br><br>You\'ve been invited to sign-up as a trusted Issuer, for the Researcher Registry (SPEEDI-AS) system. To begin your sign-up process, please 
          click the button below.<div><br></div><div>Please note, that this invitation is only valid for [[PLACEHOLDER_INVITE_TIME_HOURS]], after which, the below 
          ...
          another invite by emailing [[PLACEHOLDER_INVITE_SUPPORT_URL]], and we\'ll issue another.<br><br>Thanks!<br>SPEEDI-AS Team.<br><div><br></div><div><br></div></div></mj-text>
          </mj-column></mj-section>
          <mj-section background-repeat="repeat" background-size="auto" background-position="top center" border="none" direction="ltr" text-align="left" padding="0px 0px 0px 0px" >
          <mj-column border="none" vertical-align="top" padding="0px 0px 0px 0px" >
          <mj-button align="center" background-color="#bd10e0" color="#ffffff" font-weight="normal" border-radius="3px" line-height="120%" target="_blank" vertical-align="middle" border="none" text-align="center" href="http://localhost:3000/issuer/invited/[[PLACEHOLDER_UNIQUE_INVITE_ID]]" padding="10px 25px 10px 25px" >
          Sign me up!
