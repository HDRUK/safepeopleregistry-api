...
<mj-text font-weight="400" />
        ...
        <mj-text font-weight="400" />
          ...
          <mj-body background-color="#efeeea" width="600px" ><mj-wrapper padding="20px 0px 20px 0px" border="none" direction="ltr" text-align="center" >
          ...
          <mj-section background-repeat="repeat" background-size="auto" background-position="top center" border="none" direction="ltr" text-align="left" padding="0px 0px 0px 0px" >
          <mj-column border="none" vertical-align="top" padding="0px 0px 0px 0px" ><mj-spacer height="20px" ></mj-spacer></mj-column></mj-section>
          <mj-wrapper border="none" direction="ltr" text-align="center" padding="20px 0px 20px 0px" >
          <mj-section background-repeat="repeat" background-size="auto" background-position="top center" border="none" direction="ltr" text-align="left" padding="0px 0px 0px 0px" >
          <mj-column border="none" vertical-align="top" padding="0px 0px 0px 0px" ><mj-text align="left" padding="10px 25px 10px 25px" >
          [[custodians.name]]<br><br>You\'ve been invited to sign-up as a trusted Data Custodian, for the Researcher Registry (SPEEDI-AS) system. To begin your sign-up process, please 
          ...
          another invite by emailing [[env(SUPPORT_EMAIL)]], and we\'ll issue another.<br><br>Thanks!<br>SPEEDI-AS Team.<br><div><br></div><div><br></div></div></mj-text>
            ...
            <mjml>
              ...
              <mj-body background-color="#efeeea" width="600px">
                ...
                <mj-wrapper border="none" direction="ltr" text-align="center" padding="20px 0px 20px 0px">
                    ...
                    <mj-section background-repeat="repeat" background-size="auto" background-position="top center" border="none" direction="ltr" text-align="left" padding="0px 0px 0px 0px" >
                      <mj-column border="none" vertical-align="top" padding="0px 0px 0px 0px" >
                        <mj-button align="center" background-color="#bd10e0" color="#ffffff" font-weight="normal" border-radius="3px" line-height="120%" target="_blank" vertical-align="middle" border="none" text-align="center" href="http://localhost:3000/data-custodian/invite/[[user.email]]/user" padding="10px 25px 10px 25px" >
                          Sign me up!
                        </mj-button>
                      </mj-column>
                    </mj-section>
                ...
                <mj-section background-repeat="repeat" background-size="auto" background-position="top center" border="none" direction="ltr" text-align="left" padding="0px 0px 0px 0px">
                  <mj-column border="none" vertical-align="top" padding="0px 0px 0px 0px">
                    ...
                    <div>
                      ...
                      <div>Please note, that this verification is only valid for [[env(INVITE_TIME_HOURS)]] hour(s), after which, the link below
                        ...
                        another by emailing [[env(SUPPORT_EMAIL)]].<br/><br/>Thanks!<br/>SPEEDI-AS Team.<br/>
                        <div><br></div>
                        <div><br></div>
                      </div>
                    </mj-text>
