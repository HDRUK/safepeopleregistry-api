...
//use App\Observers\CustodianHasOrganisationObserver;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        CustodianHasProjectUser::observe(CustodianHasProjectUserObserver::class);
        //CustodianHasOrganisation::observe(CustodianHasOrganisationObserver::class);
